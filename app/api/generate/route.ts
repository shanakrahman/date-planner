  ...
  "stops": [
    {
      ...
      "must_try": "string — the single most iconic thing to order or experience here, be specific (e.g. 'The egg tarts — flaky pastry shell with silky custard, order 2-3 per person')",
